...
| 4 | Radius | Specifies the measured object radius. | [Decimal](../../types/decimal.md) | Yes | See [Decimal](../../types/decimal.md) allowed values. |
...
|---|---|---|---|---|---|---|---|
| ^^DIMRAD | MyDimStyle | 100 | 100 | 65 | 300 | 300 | <> mm |
